...
cat(int fd)
{
  ...
  47:	6a 01                	push   $0x1
  49:	e8 c0 03 00 00       	call   40e <printf>
      exit();
  ...
  64:	6a 01                	push   $0x1
  66:	e8 a3 03 00 00       	call   40e <printf>
    exit();
...
main(int argc, char *argv[])
{
  ...
  ef:	6a 01                	push   $0x1
  f1:	e8 18 03 00 00       	call   40e <printf>
      exit();
...
0000035d <get_siblings_info>:
SYSCALL(get_siblings_info)
 35d:	b8 16 00 00 00       	mov    $0x16,%eax
 362:	cd 40                	int    $0x40
 364:	c3                   	ret    

00000365 <get_ancestors>:
...
putc(int fd, char c)
{
 ...
 37b:	52                   	push   %edx
 37c:	50                   	push   %eax
 37d:	e8 5b ff ff ff       	call   2dd <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a3:	74 42                	je     3e7 <printint+0x60>
    neg = 1;
    x = -xx;
 3a5:	f7 de                	neg    %esi
    neg = 1;
 ...
 40c:	eb ee                	jmp    3fc <printint+0x75>
...
printf(int fd, const char *fmt, ...)
{
 ...
 474:	08 d1                	or     %dl,%cl
 476:	75 63                	jne    4db <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 478:	83 f8 73             	cmp    $0x73,%eax
 47b:	0f 84 84 00 00 00    	je     505 <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 484:	0f 84 b7 00 00 00    	je     541 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 48a:	83 f8 25             	cmp    $0x25,%eax
 48d:	0f 84 cc 00 00 00    	je     55f <printf+0x151>
        putc(fd, c);
      } else {
 ...
 4a5:	e8 c3 fe ff ff       	call   36d <putc>
      }
      state = 0;
 4aa:	be 00 00 00 00       	mov    $0x0,%esi
 4af:	eb 8d                	jmp    43e <printf+0x30>
        printint(fd, *ap, 10, 1);
 ...
 4c3:	e8 bf fe ff ff       	call   387 <printint>
        ap++;
 ...
 4d6:	e9 63 ff ff ff       	jmp    43e <printf+0x30>
        printint(fd, *ap, 16, 0);
 ...
 4ed:	e8 95 fe ff ff       	call   387 <printint>
        ap++;
 ...
 500:	e9 39 ff ff ff       	jmp    43e <printf+0x30>
        s = (char*)*ap;
 ...
 56e:	e9 cb fe ff ff       	jmp    43e <printf+0x30>
    }
  }
}
...
free(void *ap)
{
 ...
 590:	eb 02                	jmp    594 <free+0x19>
 592:	89 d0                	mov    %edx,%eax
 594:	39 c8                	cmp    %ecx,%eax
 596:	73 04                	jae    59c <free+0x21>
 598:	39 08                	cmp    %ecx,(%eax)
 59a:	77 12                	ja     5ae <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 59c:	8b 10                	mov    (%eax),%edx
 59e:	39 c2                	cmp    %eax,%edx
 5a0:	77 f0                	ja     592 <free+0x17>
 5a2:	39 c8                	cmp    %ecx,%eax
 5a4:	72 08                	jb     5ae <free+0x33>
 5a6:	39 ca                	cmp    %ecx,%edx
 5a8:	77 04                	ja     5ae <free+0x33>
 5aa:	89 d0                	mov    %edx,%eax
 5ac:	eb e6                	jmp    594 <free+0x19>
      break;
...
morecore(uint nu)
{
 ...
 5fd:	77 05                	ja     604 <morecore+0x15>
    nu = 4096;
 ...
 60e:	50                   	push   %eax
 60f:	e8 31 fd ff ff       	call   345 <sbrk>
  if(p == (char*)-1)
 614:	83 c4 10             	add    $0x10,%esp
 617:	83 f8 ff             	cmp    $0xffffffff,%eax
 61a:	74 1c                	je     638 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 625:	50                   	push   %eax
 626:	e8 50 ff ff ff       	call   57b <free>
  return freep;
 ...
 63d:	eb f4                	jmp    633 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 65e:	74 04                	je     664 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 660:	8b 01                	mov    (%ecx),%eax
 662:	eb 4b                	jmp    6af <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 ...
 687:	eb d7                	jmp    660 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 689:	74 1a                	je     6a5 <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 6b4:	73 d3                	jae    689 <malloc+0x4a>
    if(p == freep)
 6b6:	39 05 00 0a 00 00    	cmp    %eax,0xa00
 6bc:	75 ed                	jne    6ab <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
 6be:	89 d8                	mov    %ebx,%eax
 6c0:	e8 2a ff ff ff       	call   5ef <morecore>
 6c5:	85 c0                	test   %eax,%eax
 6c7:	75 e2                	jne    6ab <malloc+0x6c>
 6c9:	eb d4                	jmp    69f <malloc+0x60>
